 ...
 * It contains information about the contract number, start date, duration in months,
...
public class Contract {
    ...
    /**
     * Calculates the payment amount for the specified month using the payment service.
     *
    ...
    /**
     * Generates a report of the contract, including information about the contract number
     * and details of each installment, such as installment number, payment amount, and due date.
     *
    ...
    public String report(){
        ...
        for(int i = 1; i <= numberOfMonths; i++){
            ...
            reportBuilder.append("#").append(i).append(" = ").append(amount).append(" na Data: ").append(parcelDate.toString()).append("\n");
        }
